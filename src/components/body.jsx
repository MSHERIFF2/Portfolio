                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    <h4 className="text-xl font-bold text-white group-hover:text-blue-400 flex items-center justify-between">
                      {project.title}
                      <span className="text-slate-600 transition-transform group-hover:-translate-y-1 group-hover:translate-x-1">
                        ↗
                      </span>
                    </h4>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags &&
                      project.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-2 py-1 text-[10px] font-bold uppercase tracking-wider bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded"
                        >
                          {tag}
                        </span>
                      ))}
        ...
        <section id="skills">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {skills.map((skill, index) => (
              ...
              >
                <h4 className="font-bold text-blue-400 mb-4 text-sm uppercase tracking-wider">
                  {skill.title}
                </h4>
                <div className="flex flex-wrap gap-2">
